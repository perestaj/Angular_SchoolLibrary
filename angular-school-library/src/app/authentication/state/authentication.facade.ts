...
export class AuthenticationFacade {
    ...
    public authorizeFromLocalStorage(): void {
        this._store.dispatch(new authenticationActions.AuthorizeFromLocalStorageAction());
    }

    public login(loginData: ILogin): void {
        this._store.dispatch(new authenticationActions.LoginAction(loginData));
    }

    public logOff(): void {
        this._store.dispatch(new authenticationActions.LogOffAction());
    }

    public getInvalidUsernamePassword(): Observable<boolean> {
        return this._store.pipe(select(getInvalidUsernamePassword));
    }

    public getCurrentUser(): Observable<ICurrentUser> {
        return this._store.pipe(select(getCurrentUser));
    }

    public getCanRequestBook(): Observable<boolean> {
        return this._store.pipe(select(getCanRequestBook));
    }

    public getCanDeleteBook(): Observable<boolean> {
        return this._store.pipe(select(getCanDeleteBook));
    }

    public getCanAddBook(): Observable<boolean> {
        return this._store.pipe(select(getCanAddBook));
    }

    public getCanEditBook(): Observable<boolean> {
        return this._store.pipe(select(getCanEditBook));
    }

    public getCanDisplayLoans(): Observable<boolean> {
        return this._store.pipe(select(getCanDisplayLoans));
    }

    public getCanEditLoans(): Observable<boolean> {
        return this._store.pipe(select(getCanEditLoans));
    }

    public getCanEditAuthors(): Observable<boolean> {
        return this._store.pipe(select(getCanEditAuthors));
    }

    public getCanDisplayPublishers(): Observable<boolean> {
        return this._store.pipe(select(getCanDisplayPublishers));
    }

    public getCanDisplayUsers(): Observable<boolean> {
        return this._store.pipe(select(getCanDisplayUsers));
    }

    public getCanEditPublishers(): Observable<boolean> {
        return this._store.pipe(select(getCanEditPublishers));
    }

    public getCanEditUsers(): Observable<boolean> {
        return this._store.pipe(select(getCanEditUsers));
    }

    public getDisplayAdministrationLink(): Observable<boolean> {
        return this._store.pipe(select(getDisplayAdministrationLink));
    }
}
